...
const NavBar = ({showSideBar, setShowSidebar}) => {
  ...
  const sideBarHandler = () => {
    ...
    console.log('clicked')
    console.log(showSideBar?'true':'false')
  }

  return (
    <div className='transition-all ease-in duration-1000 w-screen relative h-16 px-12 py-4 bg-teal'>
      <div onClick={() => sideBarHandler()} className="flex flex-col w-11 h-8 rounded-sm place-content-center justify-center border-2 border-base">
