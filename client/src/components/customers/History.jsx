        ...
        <div className=" w-11/12screen lg:w-100per">
          <div className="w-full p-12 mt-10 overflow-auto  bg-dblue">
            <div className="flex flex-row mb-5">
              ...
              <p className="min-w-200 w-200 text-lg mt-2 ml-10 text-white italic font-bold">
                Date
              </p>
            </div>
            ...
            <div className="mt-5 max-h-80">
              {theOrders?.map((order) => (
                ...
                >
                  ...
                  <p className="text-md w-full min-w-200 h-10 place-content-center ml-10 place-self-center text-white">
